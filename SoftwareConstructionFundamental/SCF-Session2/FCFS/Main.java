...
public class Main {
    public static void main(String args[]) {
    	...
    	FcfsAlgorithm.computeCompletionTime(process);
    	
    	FcfsAlgorithm.computeTurnAroundTime(process);
    	FcfsAlgorithm.computeWaitingTime(process);
    	
    	System.out.println("process id\tArrival time\tBurst time\tCompletion time\tWaiting time\tTurnAround time");
    	...
    	System.out.println("Average Waiting Time:"+ FcfsAlgorithm.computeAverageWaitingTime(process)+"\n"+
    	                   "Maximum Waiting time:"+ FcfsAlgorithm.computeMaxWaitingTime(process));
    }
}
